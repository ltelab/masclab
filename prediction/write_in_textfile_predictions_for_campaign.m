...
filename = './PLATO_2019_MASC_classification_full.dat';
...
fprintf(fid,'# columns header: 1) particle timestamp [UTC], 2) particle ID, 3) camera ID 4) particle type 5) particle degree of riming 6) is melting? 7) quality parameter 8) Dmax [mm] 9) Area [mm^2] 10) Aspect Ratio 11) Shape complexity 12) Orientation 13) Fallspeed 14) Mean brightness [0-1] 15) Maximum brightness [0-1] 16-21) Probabilities for hydrometeor classification \n');
