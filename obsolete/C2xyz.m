...
% [x,y,z] = C2xyz(C) returns the x and y coordinates of contours in a contour
% matrix and their corresponding z values. C is the contour matrix given by 
% the contour function. 
% 
% * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
% EXAMPLE: You have a contour plot and and you want to know the (x,y)
% coordinates of the contours, as well as the z value corresponding to each
% contour line. 
%
% C = contour(peaks); 
% [x,y,z] = C2xyz(C);
