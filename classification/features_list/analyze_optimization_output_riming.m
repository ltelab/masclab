...
a = load('BEST_CONF_weights/out_riming_1it_seed1_FS_CV4_RMSE_80D.mat'); 
b = load('BEST_CONF_weights/out_riming_1it_rand1_FS_CV4_RMSE_80D.mat');
c = load('BEST_CONF_weights/out_riming_10it_rand_FS_CV4_RMSE_D80.mat');
%d = load('out_riming_10it_norand_FS_CV4.mat');
...
%overview
figure;
subplot(221); grid on; hold on; box on;
...
ylabel('BER [%]');
subplot(222); grid on; hold on; box on;
